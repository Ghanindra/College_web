...
export default function DashboardOverview({ formData, token }) {
    ...
    const fetchTotalForms = async () => {
      try {
        const res = await axios.get(
          `${Base_Url}/forms/student/my-form`,
          {
  ...
  return (
    <>
      ...
      <div
        className="min-h-screen bg-slate-50 pt-16 px-3 sm:px-4 md:px-6 lg:px-10 xl:px-12 py-6 sm:py-8"
      ...
      >
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          {/* Header */}
          <div className="anim-0 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 sm:mb-8">
            <div>
            ...
            <div
              className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-white text-xs sm:text-sm text-slate-500 font-medium self-start sm:self-auto"
              style={{
            ...
            >
              <span>📅</span>
              <span className="text-[11px] sm:text-sm">{today}</span>
            </div>
          </div>

          {/* Welcome Banner */}
          <div
            className="anim-1 relative overflow-hidden rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4"
            style={{
          ...
          >
            <div
              className="absolute -right-10 -top-10 w-40 sm:w-52 h-40 sm:h-52 rounded-full opacity-20 pointer-events-none"
              style={{
                background: "radial-gradient(circle, #c9a84c, transparent 70%)",
              }}
            />
            <div
              className="absolute right-10 sm:right-20 bottom-0 w-20 sm:w-32 h-20 sm:h-32 rounded-full opacity-10 pointer-events-none"
              style={{ background: "radial-gradient(circle, #fff, transparent 70%)" }}
            />

            <div className="relative z-10 flex-1">
              <p
                className="text-[10px] sm:text-sm font-semibold uppercase tracking-widest mb-1"
            ...
            <div
              className="relative z-10 flex items-center gap-3 px-3 sm:px-4 py-2 sm:py-3 rounded-xl self-start md:self-auto"
              style={{
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p
                  ...
                  style={{ color: "rgba(201,168,76,.6)", letterSpacing: ".1em" }}
                >
                  EST. 1959
                </p>
              </div>
          ...
          {/* Section Label */}
          <div className="anim-2 flex items-center gap-3 mb-4 sm:mb-5">
          ...
          {/* Stat Cards GRID FIX */}
          <div className="anim-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4">
            ...
            {/* Quick Info */}
            <div
              className="bg-white rounded-2xl p-4 sm:p-5 flex flex-col gap-3 min-w-0"
              style={{
                border: "1px solid #e8edf2",
                boxShadow:
              ...
              <div className="flex flex-col gap-2.5">
                {[
                  ...
                  >
                    ...
                    <span className="text-xs sm:text-sm font-semibold text-slate-700 text-right break-words">
                      {val}
                    </span>
                  </div>
                ))}
