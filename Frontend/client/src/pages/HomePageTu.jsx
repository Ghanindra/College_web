...
const SectionHeader = ({ badge, title, subtitle, center }) => {
  return (
    <div
      className={`mb-14 ${
    ...
    >
      <div className="inline-flex items-center gap-2 rounded-full border border-amber-400/20 bg-amber-400/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-amber-500">
...
const HeroSection = ({
  ...
  return (
    ...
    >
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-slate-950/90 via-slate-900/70 to-black/40" />
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-start justify-between gap-12 px-6 py-28 lg:flex-row lg:items-end">
        {/* Left */}
        <div className="max-w-4xl">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link
              to="/about"
              className="rounded-2xl bg-amber-500 px-7 py-4 text-sm font-bold uppercase tracking-wider text-slate-900 transition-all duration-300 hover:-translate-y-1 hover:bg-amber-400"
            >
              Explore University
            </Link>
            ...
            <Link
              to="/admission"
              className="rounded-2xl border border-white/20 bg-white/10 px-7 py-4 text-sm font-bold uppercase tracking-wider text-white backdrop-blur-xl transition-all duration-300 hover:bg-white/20"
            >
              Admission
            </Link>
          </div>
...
const NewsCard = ({ news }) => {
  return (
    <Link
      to={`/news/${news._id}`}
      className="group flex items-start gap-5 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl"
    >
      ...
      <div className="flex-1">
        <h3 className="line-clamp-2 text-lg font-bold text-slate-900 transition-colors duration-300 group-hover:text-amber-500">
          {news.title}
        </h3>
      ...
      <ChevronRight className="mt-1 h-5 w-5 text-slate-400 transition-transform duration-300 group-hover:translate-x-1" />
    </Link>
  );
};
  ...
  return (
    ...
    >
      <div className="relative h-56 overflow-hidden">
        ...
        <div className="absolute left-5 top-5 rounded-2xl bg-slate-900/90 px-4 py-3 text-center text-white backdrop-blur-xl">
...
const ActivityCard = ({ item }) => {
  return (
    <div className="group overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-3 hover:shadow-2xl">
      <div className="relative h-72 overflow-hidden">
        ...
        <div className="absolute left-4 top-4 rounded-full bg-white/90 px-4 py-2 text-xs font-bold uppercase tracking-wider text-slate-900 backdrop-blur-xl">
          {item.type}
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        <div className="inline-flex rounded-full border border-amber-400/30 bg-amber-400/10 px-5 py-2 text-xs font-bold uppercase tracking-[0.2em] text-amber-300">
          Academic Excellence
        </div>

        <h2 className="mt-8 text-4xl font-black leading-tight text-white md:text-6xl">
          TU Convocation Ceremony
        </h2>

        <p className="mx-auto mt-8 max-w-3xl text-lg leading-9 text-slate-200">
          Celebrating achievements, innovation, and the future
          leaders of Nepal through academic distinction and
          excellence.
        </p>

        <Link
          to="/tuconvocation"
          className="mt-10 inline-flex items-center gap-2 rounded-2xl bg-amber-500 px-8 py-4 text-sm font-bold uppercase tracking-wider text-slate-900 transition-all duration-300 hover:-translate-y-1 hover:bg-amber-400"
        >
          Explore Convocation
    ...
    <section className="bg-white py-24">
      <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:items-center">
        ...
        <div>
          ...
          <p className="mt-2 text-sm font-semibold uppercase tracking-[0.2em] text-amber-600">
          ...
          <div className="mt-8 border-l-4 border-amber-500 pl-6">
            <p className="text-lg italic leading-9 text-slate-600">
              "Tribhuvan University remains committed to
              excellence in education, research, innovation,
              and national development while preparing future
              generations for global leadership."
            </p>
          </div>

          <Link
            to="/vicechancellormessage"
            className="mt-10 inline-flex items-center gap-2 rounded-2xl bg-slate-900 px-8 py-4 text-sm font-bold uppercase tracking-wider text-white transition-all duration-300 hover:-translate-y-1 hover:bg-slate-800"
          >
            Read Full Message
            <ChevronRight className="h-5 w-5" />
          </Link>
...
export default function HomePageTU() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${Base_Url}/notices?limit=4`)
      .then((r) => setLatestNews(r.data.notices || []))
      .catch(() => {});

    axios
      .get(`${Base_Url}/events?limit=4`)
      .then((r) => setEvents(r.data.events || []))
      .catch(() => {});
  }, []);

  // KEEPING ORIGINAL HERO LOGIC
  const heroSlides = [
    {
      image: hero1,
      kicker: "Excellence in Education",
      title:
        "Shaping Nepal's Future Through Knowledge",
      sub:
        "Nepal's oldest and largest university empowering generations since 1959.",
      badge: {
        label: "Constituent Campuses",
        val: "60+",
      },
    },
    {
      ...
      title:
        "Building a University of Global Distinction",
      sub:
        "Advancing academic excellence and innovation throughout Nepal.",
      badge: {
    ...
    },
    {
      ...
      kicker: "Our Campus",
      title:
        "The Heart of Learning at Kirtipur",
      sub:
        "A vibrant community of scholars, innovators, and researchers.",
      badge: {
        label: "Students",
        val: "400K+",
      },
    },
    {
      ...
      title:
        "Office of the Registrar Serving Academia",
      sub:
        "Dedicated to academic excellence and administration.",
      badge: {
        label: "Faculties",
        val: "5",
      },
    ...
    <div className="overflow-hidden bg-slate-50">
      ...
      <section className="bg-slate-50 py-24">
        <div className="mx-auto max-w-7xl px-6">
          <SectionHeader
            badge="University Updates"
            title="Latest News & Upcoming Events"
            subtitle="Stay informed with the latest university announcements, academic updates, and upcoming events."
            center
          />
      ...
      <section className="bg-slate-50 py-24">
        <div className="mx-auto max-w-7xl px-6">
          <SectionHeader
            ...
            subtitle="Explore moments, achievements, and activities happening across Tribhuvan University."
            center
          />
          ...
          <div className="mt-14 text-center">
            <Link
              to="/activities"
              className="inline-flex items-center gap-2 rounded-2xl bg-slate-900 px-8 py-4 text-sm font-bold uppercase tracking-wider text-white transition-all duration-300 hover:-translate-y-1 hover:bg-slate-800"
            >
              View All Activities
              <ChevronRight className="h-5 w-5" />
            </Link>
